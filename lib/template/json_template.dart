...
///
class JsonTemplate extends Template<Map> {

  /// Initializes the [JsonTemplate] with the help of
  /// a JSON [template] map which is generated by
  /// `JSON.decode()`
  JsonTemplate(Map template, String id, TemplateController controller, {Logger logger}) :
    super(template, id, controller, logger: logger);

  /// Initializes the [JsonTemplate] with the help of
  /// a JSON [template] string
  JsonTemplate.fromJson(String template, String id, TemplateController controller, {Logger logger}) :
    super(JSON.decode(template), id, controller, logger: logger);
...
class JsonTemplateNodeConverter extends TemplateNodeConverter<Map> {
  ...
  TemplateNode convert(Map value) {
    return _convert(value);
  }

  Map convertBack(TemplateNode value) {
