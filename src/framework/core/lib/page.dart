...
class Page {
  ...
  Page(this.uri, this.title, {HtmlTemplate template, this.logger}) : fragments = new List<Fragment>() {
    //load default template
    if (template == null) {
      template = new DefaultPageTemplate(logger: logger); //TODO create default trmplate
    }
